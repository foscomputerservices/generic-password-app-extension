...
Pod::Spec.new do |s|
  ...
  s.homepage          = "https://github.com/foscomputerservices/generic-password-app-extension.git"
  ...
  s.source            = { :git => "https://github.com/foscomputerservices/generic-password-app-extension.git", :tag => s.version }
  s.platform          = :ios, 7.0
  s.source_files      = "*.{h,m}"
  s.frameworks        = "UIKit"
